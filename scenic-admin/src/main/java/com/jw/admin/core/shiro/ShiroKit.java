...
public class ShiroKit {
  ...
  /*  public static List<Integer> getDeptDataScope() {
        ...
        // ConstantFactory.me().getSubDeptId(deptId);
     ...
     * 获取当前用户的部门数据范围的集合
     */
    public static List<Integer> getScenicDataScope() {
        Integer scenicId = getUser().getScenicId();
        List<Integer> subScenicIds = new ArrayList();
        // ConstantFactory.me().getSubDeptId(deptId);
        subScenicIds.add(scenicId);
        return subScenicIds;
    }
    ...
    public static boolean isAdmin() {
        ...
        for (Integer integer : roleList) {
            String singleRoleTip = null;
            //ConstantFactory.me().getSingleRoleTip(integer);
            if (Const.ADMIN_NAME.equals(singleRoleTip)) {
                return true;
            }
        }
        return false;
