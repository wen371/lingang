...
//         //提示
//         title:"上传视频",
//         //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon charts.png
//         cssRules :'background-position: -382px 119px;',
//         //点击时执行的命令
//         onclick:function () {
...
//                 //fix: false, //不固定
//                 maxmin: true,
//                 content: Feng.ctxPath + '/scenicSpot/chooseVideo'
//             });
//             // layer.full(index);
...
UE.registerUI('uploadMaterial',function(editor,uiName){
    editor.registerCommand(uiName,{
        execCommand:function(){
