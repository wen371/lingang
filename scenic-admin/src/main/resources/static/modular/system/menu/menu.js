...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单名称', field:'name', align:'center', valign: 'middle', sortable: true,width:'20%'},
        {title: '菜单编号', field:'code', align:'center', valign: 'middle', sortable: true,width:'15%'},
 ...
 * 状态编辑
 */
Menu.upStatus = function () {
    if (this.check()) {
        var operation = function(){
            var ajax = new $ax(Feng.ctxPath + "/menu/upstatus", function (data) {
                Feng.success("修改成功!");
                Menu.table.refresh();
            }, function (data) {
        ...
        Feng.confirm("是否更改该状态?", operation);
    }
};
