...
Admin.initColumn = function () {
    var columns = [
        ...
        {title: '景区', field: 'scenicName', align: 'center', valign: 'middle'},
...
/*    if(Admin.deptId==-1){
    ...
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/admin/admin_add?deptId=1'     //+Admin.deptId
    });
...
$(function () {
    ...
    var table = new BSTable("adminTable", "/admin/list", defaultColunms);
