    ...
    $ZTreeOrg.prototype = {
		...
		loadNodes : function() {
			...
			var ajax = new $ax(Feng.ctxPath + this.url, function(data) {
                for (var o in data) {
                    if (data[o].innerCode.length == 10) {
                       /* data[o].icon = Feng.ctxPath + '/static/img/dept.png';*/
                        data[o].iconSkin ="bgs";
                    }
                    if (data[o].innerCode.length == 13) {
                        data[o].iconSkin ="bgn";
                    }
                    if (data[o].innerCode.length == 14) {
                        data[o].iconSkin ="bgg";
                    }
