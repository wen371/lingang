...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="thumbnail file-preview {class}">\n' +
                '    {close}' +
                '    <div class="{dropClass}">\n' +
            ...
            tTagBef = '<div class="thumbnail col-sm-3 file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" style="\n' +
                '    width: 24.25%;\n' +
            ...
            tZoomCache = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div><div style="width: 1%;height:5px;float: left;"></div>';
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgFilesTooMany: '您最多只能上传<b>{m}</b>张,超出上传限制',
        ...
        msgInvalidFileType: '文件格式不支持只能上传"{types}"文件',
