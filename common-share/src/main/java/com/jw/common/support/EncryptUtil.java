...
/**
 * Created with com.jw.common.support.
 * Date: 2019/7/31
 */
...
//                SecureRandom secureRandom = new SecureRandom(keyBytes);
    ...
    public static void main(String[] args) {
        ...
        //String ss = "Z9XB7PSB_2";
        String SS = "19F7F472441F1D8157E842254469508B";
        String S = AESdecode(SS, "qrc");
       // String s = AESencode(ss, "qrc");
        //String s1 =AESdecode(s, "qrc");
        //System.out.println(s);
        System.out.println(S);*/
        /*String x = s + "_" + String.valueOf(String.valueOf(new Date().getTime()));
        System.out.println(x);
        System.out.println(x.length());*/
//        String abc = AESdecode(s, "qrc");
